...
extern "C" {
    ...
    GDExtensionBool GDE_EXPORT wayland_compositor_library_init(
        ...
        init_obj.register_initializer(initialize_wayland_compositor_module);
        init_obj.register_terminator(uninitialize_wayland_compositor_module);
